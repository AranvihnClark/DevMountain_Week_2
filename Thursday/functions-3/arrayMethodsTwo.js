...
console.log("--------------------------------------------------------\n");
const checkFruits = fruits.forEach((el) => {
  if(el.color === "red") console.log(`The fruit with index ${fruits.indexOf(el)} is an apple.`);
  else if(el.color === "orange") console.log(`The fruit with index ${fruits.indexOf(el)} is an orage.`);
  else console.log(`The fruit with index ${fruits.indexOf(el)} is neither apple or orange.`);
})
checkFruits;
console.log();
/* 
...
/*
The fruit with index 0 is neither apple or orange.
The fruit with index 1 is an orage.
The fruit with index 2 is neither apple or orange.
The fruit with index 3 is an apple.
*/
////////// PROBLEM 5 //////////
